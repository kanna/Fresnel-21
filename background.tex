...
courses which are not included in the forecast models (\kc{figure photo
conditions off coast \naze})
...
observations have showed \kc{citation?} that these contributions
\kc{``combine in a fresh and high turbidity'' -- unclear} that can
extend its influence over the complete shelf \kc{(include photo --
  which photo?)}.
