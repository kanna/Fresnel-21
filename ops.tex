...
experiment in the Spring of 2022, considering the current pandemic
situation and the associated uncertainties, we have backup plans for
the Fall of 2022, which are coincident with when the \inst vessel
...
restrictions imposed by the Portuguese authorities. 
